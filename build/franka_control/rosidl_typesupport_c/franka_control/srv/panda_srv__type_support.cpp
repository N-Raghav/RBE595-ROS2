...
static const _PandaSrv_Request_type_support_symbol_names_t _PandaSrv_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, franka_control, srv, PandaSrv_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, franka_control, srv, PandaSrv_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, franka_control, srv, PandaSrv_Request)() {
  return &::franka_control::srv::rosidl_typesupport_c::PandaSrv_Request_message_type_support_handle;
}
...
static const _PandaSrv_Response_type_support_symbol_names_t _PandaSrv_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, franka_control, srv, PandaSrv_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, franka_control, srv, PandaSrv_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, franka_control, srv, PandaSrv_Response)() {
  return &::franka_control::srv::rosidl_typesupport_c::PandaSrv_Response_message_type_support_handle;
}
...
static const _PandaSrv_type_support_symbol_names_t _PandaSrv_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, franka_control, srv, PandaSrv)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, franka_control, srv, PandaSrv)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, franka_control, srv, PandaSrv)() {
  return &::franka_control::srv::rosidl_typesupport_c::PandaSrv_service_type_support_handle;
}
