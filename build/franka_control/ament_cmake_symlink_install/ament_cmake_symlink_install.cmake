...
function(ament_cmake_symlink_install_directory cmake_current_source_dir)
  ...
  if(NOT IS_ABSOLUTE "${ARG_DESTINATION}")
    set(ARG_DESTINATION "/home/merlabros2/RBE595/install/franka_control/${ARG_DESTINATION}")
  endif()
...
function(ament_cmake_symlink_install_targets)
  ...
  foreach(file ${ARG_TARGET_FILES})
    ...
    if(NOT IS_ABSOLUTE "${destination}")
      set(destination "/home/merlabros2/RBE595/install/franka_control/${destination}")
    endif()
...
# install("TARGETS" "franka_control__rosidl_typesupport_introspection_c__pyext" "DESTINATION" "local/lib/python3.10/dist-packages/franka_control")
include("/home/merlabros2/RBE595/build/franka_control/ament_cmake_symlink_install_targets_1_${CMAKE_INSTALL_CONFIG_NAME}.cmake")

# install("TARGETS" "franka_control__rosidl_typesupport_c__pyext" "DESTINATION" "local/lib/python3.10/dist-packages/franka_control")
