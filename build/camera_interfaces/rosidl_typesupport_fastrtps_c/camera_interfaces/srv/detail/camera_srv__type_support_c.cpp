...
#include "camera_interfaces/srv/detail/camera_srv__rosidl_typesupport_fastrtps_c.h"
...
using _CameraSrv_Request__ros_msg_type = camera_interfaces__srv__CameraSrv_Request;
...
static uint32_t _CameraSrv_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_camera_interfaces__srv__CameraSrv_Request(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = camera_interfaces__srv__CameraSrv_Request;
    is_plain =
      (
...
static size_t _CameraSrv_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_camera_interfaces__srv__CameraSrv_Request(
...
// forward declare type support functions
ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPORT_camera_interfaces
...
using _CameraSrv_Response__ros_msg_type = camera_interfaces__srv__CameraSrv_Response;
...
{
  return static_cast<uint32_t>(
    get_serialized_size_camera_interfaces__srv__CameraSrv_Response(
      untyped_ros_message, 0));
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = camera_interfaces__srv__CameraSrv_Response;
    is_plain =
      (
...
static size_t _CameraSrv_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_camera_interfaces__srv__CameraSrv_Response(
    full_bounded, is_plain, 0);
...
// already included above
// #include "camera_interfaces/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "camera_interfaces/srv/camera_srv.h"
